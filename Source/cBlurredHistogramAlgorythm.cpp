...
cBlurredHistogramAlgorythm::cBlurredHistogramAlgorythm(void)
{
}
...
cData cBlurredHistogramAlgorythm::Compare(cBitmap bitmap1, cBitmap bitmap2)
{
	float errorPixel = 0;
	int blur1,blur2;
	...
	int hResolution;
	std::cin >> hResolution;
	std::cout << "Enter 1 and 2 blur multiplier" << std::endl;
	std::cin >> blur1;
	std::cout << std::endl;
	std::cin >> blur2;

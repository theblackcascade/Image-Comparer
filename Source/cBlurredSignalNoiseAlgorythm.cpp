...
cBlurredSignalNoiseAlgorythm::cBlurredSignalNoiseAlgorythm(void)
{
}
...
cData cBlurredSignalNoiseAlgorythm::Compare(cBitmap bitmap1, cBitmap bitmap2)
{
	float errorPixel = 0;
	...
	std::cin >> hResolution;
	std::cout << "Enter 1 and 2 Blur value" << std::endl;
	std::cin >> blur1;
	std::cout << std::endl;
	std::cin >> blur2;
